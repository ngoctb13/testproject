                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="widget mb-3">
                                ...
                                <p>Đại học FPT Hà Nội tọa lạc tại Khu Công nghệ cao Hòa Lạc, Km29 Đại lộ Thăng Long, huyện Thạch Thất, Hà Nội.</p>
                                <p>MST: 0102100740</p>
                            </div>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            <div class="widget mb-3">
                                <h3 class="footer-heading footer-heading-white">Comment for us</h3>
                                <form action="#">
